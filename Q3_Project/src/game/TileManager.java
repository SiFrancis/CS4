...
public class TileManager {
    ...
    public void getTileImage() {
        ...
        tileSet[94] = new Tile("render/094.png", true);
        tileSet[95] = new Tile("render/095.png", true);
        tileSet[96] = new Tile("render/096.png", true);
        tileSet[97] = new Tile("render/097.png", false);
        tileSet[98] = new Tile("render/098.png", true);
        tileSet[99] = new Tile("render/099.png", true);
        tileSet[100] = new Tile("render/100.png", true);
        tileSet[101] = new Tile("render/101.png", true);
        tileSet[102] = new Tile("render/102.png", true);
        tileSet[103] = new Tile("render/103.png", true);
        tileSet[104] = new Tile("render/104.png", true);
        tileSet[105] = new Tile("render/105.png", true);
        tileSet[106] = new Tile("render/106.png", true);
        tileSet[107] = new Tile("render/107.png", true);
        ...
        tileSet[113] = new Tile("render/113.png", true);
        tileSet[114] = new Tile("render/114.png", false);
        tileSet[115] = new Tile("render/115.png", true);
        tileSet[116] = new Tile("render/116.png", true);
        ...
        tileSet[122] = new Tile("render/122.png", true);
        ...
        tileSet[131] = new Tile("render/131.png", true);
        ...
        tileSet[139] = new Tile("render/139.png", true);
        ...
        tileSet[149] = new Tile("render/149.png", true);
        tileSet[150] = new Tile("render/150.png", true);
        tileSet[151] = new Tile("render/151.png", true);
        tileSet[152] = new Tile("render/152.png", false);
        tileSet[153] = new Tile("render/153.png", true);
        tileSet[154] = new Tile("render/154.png", true);
        tileSet[155] = new Tile("render/155.png", true);
